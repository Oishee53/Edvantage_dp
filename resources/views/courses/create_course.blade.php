                        ...
                        <div class="bg-white rounded-2xl shadow-sm border border-gray-200 overflow-hidden opacity-0 animate-slide-in">
                            <div class="p-6 lg:p-8">
                                ...
                                <form action="/admin/manage_courses/create" method="POST" enctype="multipart/form-data"
                                      class="space-y-6" x-data="{ courseType: 'recorded' }">
                                ...
                                @endif
                                    ...
                                    <!-- Course Type -->
                                    <div>
                                        <label class="block text-sm font-bold text-teal-900 mb-3">
                                            Course Type <span class="text-gray-900">*</span>
                                        </label>
                                        <div class="grid grid-cols-2 gap-3">

                                            <!-- Recorded -->
                                            <label :class="courseType === 'recorded' ? 'border-teal-600 bg-teal-50 ring-2 ring-teal-600' : 'border-gray-300 hover:border-teal-400'"
                                                   class="flex items-center gap-3 p-4 border-2 rounded-xl cursor-pointer transition-all select-none">
                                                <input type="radio" name="course_type" value="recorded" x-model="courseType" class="hidden">
                                                <span :class="courseType === 'recorded' ? 'bg-teal-600' : 'bg-gray-200'"
                                                      class="w-5 h-5 rounded-full flex items-center justify-center transition-colors shrink-0">
                                                    <span x-show="courseType === 'recorded'" class="w-2.5 h-2.5 bg-white rounded-full"></span>
                                                </span>
                                                <span class="flex flex-col">
                                                    <span class="font-semibold text-sm text-gray-800">
                                                        <i class="fas fa-video mr-1 text-teal-600"></i> Recorded
                                                    </span>
                                                    <span class="text-xs text-gray-500 mt-0.5">Pre-recorded lectures</span>
                                                </span>
                                            </label>

                                            <!-- Live -->
                                            <label :class="courseType === 'live' ? 'border-indigo-600 bg-indigo-50 ring-2 ring-indigo-600' : 'border-gray-300 hover:border-indigo-400'"
                                                   class="flex items-center gap-3 p-4 border-2 rounded-xl cursor-pointer transition-all select-none">
                                                <input type="radio" name="course_type" value="live" x-model="courseType" class="hidden">
                                                <span :class="courseType === 'live' ? 'bg-indigo-600' : 'bg-gray-200'"
                                                      class="w-5 h-5 rounded-full flex items-center justify-center transition-colors shrink-0">
                                                    <span x-show="courseType === 'live'" class="w-2.5 h-2.5 bg-white rounded-full"></span>
                                                </span>
                                                <span class="flex flex-col">
                                                    <span class="font-semibold text-sm text-gray-800">
                                                        <i class="fas fa-circle text-red-500 mr-1 text-xs"></i> Live
                                                    </span>
                                                    <span class="text-xs text-gray-500 mt-0.5">Real-time sessions</span>
                                                </span>
                                            </label>
                                    ...
                                    <div>
                                        <label for="image" class="block text-sm font-bold text-teal-900 mb-2">
                                            Course Image <span class="text-gray-900">*</span>
                                        </label>
                                    ...
                                    <div>
                                        <label for="title" class="block text-sm font-bold text-teal-900 mb-2">
                                            Course Title <span class="text-gray-900">*</span>
                                        </label>
